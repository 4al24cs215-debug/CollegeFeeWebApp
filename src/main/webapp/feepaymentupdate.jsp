...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Modify existing payment record</p>
        </div>
        <div class="form-container">
            <div class="info-note">
                ℹ️ Enter the Payment ID and the new details to update the record
            </div>
            ...
            <form action="UpdateFeePaymentServlet" method="post">
                <div class="form-group">
                    ...
                    <input type="number" name="paymentId" placeholder="Enter Payment ID to update" required>
                </div>
                <div class="form-group">
